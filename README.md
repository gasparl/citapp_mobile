...
Currently, the app is only built for _Android_ (i.e., smartphones with Andriod OS). The APK file is available via https://osf.io/fjvna/, under the "CITapp" folder.
